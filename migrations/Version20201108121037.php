 ...
 */
final class Version20201108121037 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stored_event (id INT NOT NULL, aggregate_uuid VARCHAR(255) NOT NULL, event_data JSON NOT NULL, event_type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
